...
public class AbstractScreen implements Screen {
    ...
    @Override
    public void show() {
        Gdx.app.log(TemplateGame.LOG, "Showing screen: " + getName());
    ...
    public void resize(
            int width,
            int height) {
        Gdx.app.log(TemplateGame.LOG, "Resizing screen: " + getName() + " to: " + width + " x " + height);
    }
    ...
    @Override
    public void hide() {
        Gdx.app.log(TemplateGame.LOG, "Hiding screen: " + getName());
    ...
    @Override
    public void pause() {
        Gdx.app.log(TemplateGame.LOG, "Pausing screen: " + getName());
    }

    @Override
    public void resume() {
        Gdx.app.log(TemplateGame.LOG, "Resuming screen: " + getName());
    }

    @Override
    public void dispose() {
        Gdx.app.log(TemplateGame.LOG, "Disposing screen: " + getName());
